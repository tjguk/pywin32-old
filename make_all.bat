...
py -3.3-32 setup.py -q bdist_wininst --target-version=3.3 --skip-build
py -3.3-32 setup.py -q bdist_wininst --target-version=3.3 --skip-build --plat-name=win-amd64 

py -3.4-32 setup.py -q bdist_wininst --target-version=3.4 --skip-build
py -3.4-32 setup.py -q bdist_wininst --target-version=3.4 --skip-build --plat-name=win-amd64 

py -3.5-32 setup.py -q bdist_wininst --target-version=3.5 --skip-build
py -3.5-32 setup.py -q bdist_wininst --target-version=3.5 --skip-build --plat-name=win-amd64 
