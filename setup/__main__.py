...
class WinExt_pythonwin(extensions.WinExt):
    def __init__ (self, name, **kw):
        ...
        extensions.WinExt.__init__(self, name, **kw)
        self.is_win32_exe = True
    def get_pywin32_dir(self):
        return "pythonwin"

class WinExt_win32(extensions.WinExt):
    def __init__ (self, name, **kw):
        extensions.WinExt.__init__(self, name, **kw)
        self.is_win32_exe = True
    def get_pywin32_dir(self):
...
class WinExt_win32com(extensions.WinExt):
    def __init__ (self, name, **kw):
...
class WinExt_system32(extensions.WinExt):
    def get_pywin32_dir(self):
